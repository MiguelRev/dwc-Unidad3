...
const nombreCompleto = window.prompt("Introduce tu nombre y apellidos");

let nombreSeparado = nombreCompleto.trim().split(" ");

const resultado = nombreSeparado.filter(value => value != "");
...
if(resultado.length>=3){
    const nombre=resultado[0].toLowerCase();
    const apellido1=resultado[1].charAt(0).toUpperCase();
    const apellido2=resultado[2].charAt(0).toUpperCase();
